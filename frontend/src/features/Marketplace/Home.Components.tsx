...
export const Button = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement> & { variant?: 'default' | 'outline' | 'ghost' | 'secondary', size?: 'default' | 'sm' | 'icon', loading?: boolean }>(
...
export const FavoriteButton = ({ isFavorite, onClick, className }: { isFavorite: boolean, onClick: () => void, className?: string }) => (
  <button
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute bottom-2 right-2">
                         <Button size="icon" className={cn("h-8 w-8 rounded-lg transition-all", message ? "bg-blue-600 hover:bg-blue-700" : "bg-slate-200 text-slate-400")} disabled={!message || isSending} onClick={handleSendInsideModal}>
